...
type HealthServiceClient interface {
	Check(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthReponse, error)
}
...
func (c *healthServiceClient) Check(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthReponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HealthReponse)
...
type HealthServiceServer interface {
	Check(context.Context, *HealthRequest) (*HealthReponse, error)
...
func (UnimplementedHealthServiceServer) Check(context.Context, *HealthRequest) (*HealthReponse, error) {
